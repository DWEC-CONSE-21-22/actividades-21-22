...
function pinto_tablero() {
     ...
     for (var i = 0; i <= 2; i++) {
          for (var j = 0; j <= 2; j++) {
               ...
               document.getElementById(id_casilla).innerHTML = "<img src='img/"+tablero[i][j]+".png'>"; // para cada valor de la matriz, pongo su imagen correspondiente
          }
     }
}
...
function jugada(casilla) {
     ...
     console.log(casilla);
     var casilla_i=casilla.id.substring(8,9);
     console.log(casilla_i);
     var casilla_j=casilla.id.substring(9,10);
     console.log(casilla_j);
